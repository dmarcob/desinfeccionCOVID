                ...
                <div class="animated fadeIn">
                  <form class="rd-mailform text-left" id=login_usuario method="get" action="signin">
                    <div class="form-group">
                      <label for="login-nickname" class="form-label-outside">Nombre usuario</label>
                      <input id="login-nickname" type="text" name="nickname" class="form-control">
                    </div>
                    <div class="form-group">
                      <label for="login-password" class="form-label-outside">Contraseña</label>
                      <input id="login-password" type="password" name="password" class="form-control">
                    </div>
                    <div class="offset-top-18 text-center">
                      <button type="submit" class="btn btn-primary">Acceder</button>
                      <a href="historialP.html" class="btn btn-info" role="button">Acceder admin</a>
			  <!--<a href="login.html"><button type="submit" class="btn btn-primary">Acceder</button></a>-->
                    </div>
 		<div class="offset-top-18 text-center">
                      <a href="services_log.html" class="btn btn-info" role="button">Acceder user</a>
			  <!--<a href="login.html"><button type="submit" class="btn btn-primary">Acceder</button></a>-->
                    </div>
